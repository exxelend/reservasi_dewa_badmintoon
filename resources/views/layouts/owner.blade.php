        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-light navbar-light">
                <a href="/home" class="navbar-brand mx-4 mb-3">
                    <h4 class="text-primary"><i>Dewa</i></h4>
                    <h4 class="text-primary" style="margin-left: 50px"><i>Badminton Hall</i></h4>
                </a>
                ...
                <div class="navbar-nav w-100">
                    <a href="/owner-dashboard"
                        class="nav-item nav-link {{ ($currentPath == 'dashboard-owner') ? 'active' : '' }}">
                    ...
                    <a href="/admin/pemesanan"
                        class="nav-item nav-link {{ ($currentPath == 'admin/pemesanan') ? 'active' : '' }}">
                ...
                <div class="navbar-nav align-items-center ms-auto">
                    @auth
                        ...
                        <li class="nav-item dropdown p-1" id="userDropdown">
                            <a class="nav-link dropdown-toggle m-0" href="#" aria-haspopup="true"
                                aria-expanded="false">
                                {{ auth()->user()->name }}
                            </a>
            ...
            <div class="container-fluid pt-4 px-4">
                <div class="row">
                    <div class="col-12 col-sm-6 text-center text-sm-start">
                        &copy; <a href="#">DewaBadmintonHall</a>, All Right Reserved.
                    </div>
                </div>
            </div>
            <!-- Footer End -->
