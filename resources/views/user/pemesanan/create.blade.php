                ...
                <div class="card-body">
                    <form action="{{ route('pemesanan.store') }}" method="POST">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="text" class="form-control datetimepicker" id="waktu_mulai" name="waktu_mulai" value="{{ old('waktu_mulai') }}" required />
                            </div>
                        </div><br>
                        <div class="form-group row">
                            <label class="col-sm-3 col-form-label" for="waktu_akhir">{{ __('Jam Berakhir') }}</label>
                            <div class="col-sm-9">
                                <input type="text" class="form-control datetimepicker" id="waktu_akhir" name="waktu_akhir" value="{{ old('waktu_akhir') }}" required />
                            </div>
                        </div><br>
...
<script>
    $('.datetimepicker').datetimepicker({
        ...
        stepping: 60, // Memastikan hanya jam yang dapat dipilih
        minDate: moment().startOf('day') // Mencegah pemilihan tanggal masa lampau
    });
</script>
